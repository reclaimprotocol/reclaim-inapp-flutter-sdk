// Refer: https://github.com/dart-lang/sdk/issues/52121
// Taken from https://gist.github.com/mraleph/71cb2c4a7d597c9a9f310f6edb2ef4e5
...
extension on Pointer<_MailboxRepr> {
  Pointer<PthreadMutex> get mutex => Pointer<PthreadMutex>.fromAddress(address + Mailbox.mutexOffs);
  Pointer<PthreadCond> get condRequest => Pointer<PthreadCond>.fromAddress(address + Mailbox.condRequestOffs);
  Pointer<PthreadCond> get condResponse => Pointer<PthreadCond>.fromAddress(address + Mailbox.condResponseOffs);
}
