...
DateTime _fromTimeStampToDateTime(
  String ts,
) {
...
void main() {
  group('LogEntry', () {
    test('fromDateTimeToTimeStamp', () {
      ...
      final result = _fromTimeStampToDateTime(
        LogEntry.fromDateTimeToTimeStamp(now),
      );
      expect(
        result.toLocal(),
        now.toLocal(),
      ...
      expect(
        result.toUtc().toString(),
        '2024-09-27 09:14:00.000Z',
      );
    });
  });
}
