...
import 'package:reclaim_flutter_sdk/injections/mwjs.dart';
...
typedef ConvertedTemplateResult =
    (String template, List<String> allVars, List<String> unSubstitutedVars);
...
String interpolateTemplateWithValues(
  final String template,
  final Map<String, String> values,
) {
