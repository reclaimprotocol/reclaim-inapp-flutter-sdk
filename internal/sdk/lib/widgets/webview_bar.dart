...
class WebviewBar extends StatelessWidget {
  const WebviewBar({
    super.key,
  ...
  final void Function()? openDebugMenu;
  final void Function()? close;

  @override
  Widget build(BuildContext context) {
    final isWebviewProgressComplete = webviewProgress == 1.0;
...
class _ReclaimLinearProgress extends StatelessWidget {
...
class _ReclaimAddressBar extends StatelessWidget {
...
class _AddressBarUrl extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final uri = Uri.parse(webviewUrl.trim());
