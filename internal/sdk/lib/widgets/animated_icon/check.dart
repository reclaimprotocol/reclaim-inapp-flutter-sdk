...
class DataSharedCheckAnimatedIcon extends StatefulWidget {
  ...
  @override
  State<DataSharedCheckAnimatedIcon> createState() =>
      DataSharedCheckAnimatedIconState();
}

class DataSharedCheckAnimatedIconState
    extends State<DataSharedCheckAnimatedIcon>
  ...
  late final Animation<double> _icon1Animation = Tween<double>(
    ...
    CurvedAnimation(parent: _icon1Controller, curve: Curves.easeInOutCirc),
  );
  late final Animation<double> _icon2Animation = Tween<double>(
    begin: 0,
    end: 1,
  ).animate(
    CurvedAnimation(parent: _icon2Controller, curve: Curves.easeInOutCirc),
  );
