...
import 'package:reclaim_flutter_sdk/utils/widget.dart';

class DebugBottomSheet extends StatelessWidget {
  final VoidCallback refreshPage;
  final VoidCallback toggleCookiePersist;
  final VoidCallback copySessionId;
  final VoidCallback toggleUseSingleRequest;
          ...
          children:
              [
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        useSingleRequest ? Colors.green : Colors.red,
                    foregroundColor: Colors.white,
                    iconColor: Colors.white,
                  ),
                ),
...
class _ChangeLogLevelTileState extends State<ChangeLogLevelTile> {
  ...
  void openDropdown() {
    final dropdownInkWell = findChildWidgetByType<InkWell>(
