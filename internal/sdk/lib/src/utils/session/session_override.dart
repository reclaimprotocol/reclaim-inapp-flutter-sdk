...
typedef SessionCreateRequest =
    Future<SessionInitResponse?> Function({
...
typedef SessionUpdateCallback =
    Future<bool> Function(String sessionId, SessionStatus status, Map<String, dynamic>? metadata);
...
class ReclaimSessionOverride extends ReclaimOverride<ReclaimSessionOverride> {
  const ReclaimSessionOverride._raw({this.createSession, this.logRecord, this.updateSession});
  ...
  const ReclaimSessionOverride.useDefault() : createSession = null, updateSession = null, logRecord = null;
