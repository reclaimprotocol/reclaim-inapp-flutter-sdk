...
String urlSafeEncode(Uint8List data) {
  return jwkValueEncoder.removeBase64Padding(base64Url.encode(data));
}
...
Uint8List urlSafeDecode(String input) {
  return base64Url.decode(jwkValueDecoder.addBase64Padding(input));
}
