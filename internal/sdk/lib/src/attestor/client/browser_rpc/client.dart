...
class AttestorWebViewClient extends AttestorClient {
  ...
  Future<void> _postMessage(RpcMessage rpcMessage) async {
    ...
    try {
      ...
      log.finest({'tag': 'rpc.js', 'value': js});
  ...
  void _handleHostRpcMessage(List<dynamic> args) async {
    ...
    try {
      ...
      log.severe('Error handling rpc message', e, s);
    }
  }
  ...
  final _webviewLoadCompleter = Completer<void>();
  ...
  void _handleClientReady(List<dynamic> args) {
