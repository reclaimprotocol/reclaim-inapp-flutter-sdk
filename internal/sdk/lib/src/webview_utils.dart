...
import 'web_scripts/scripts/hawkeye.dart';
      ...
      try {
        ...
        if (typeof responseText !== 'string') {
          try {
            ...
            console.log('Failed to stringify responseText', e);
            responseText = responseText.toString();
          }
        }
        const headers = parsedHeaders;
        let requestBody = request.body || (request.options ? request.options.body : null);
