...
class DataSharedCheckAnimatedIcon extends StatefulWidget {
  ...
  @override
  State<DataSharedCheckAnimatedIcon> createState() => DataSharedCheckAnimatedIconState();
}

class DataSharedCheckAnimatedIconState extends State<DataSharedCheckAnimatedIcon> with TickerProviderStateMixin {
  late final AnimationController _icon1Controller = AnimationController(
    vsync: this,
    duration: const Duration(milliseconds: 750),
  );
  late final AnimationController _icon2Controller = AnimationController(
    vsync: this,
  ...
  ).animate(CurvedAnimation(parent: _icon2Controller, curve: Curves.easeInOutCirc));
  ...
  void reset() {
    _icon1Controller.reset();
    _icon2Controller.reset();
  }
      ...
      children: [
        Padding(
          ...
          child: AnimatedCheck(
            ...
            ).animate(CurvedAnimation(parent: _icon1Animation, curve: Curves.easeInOut)),
            size: dimension,
            color: Colors.black,
...
class AnimatedCheck extends StatefulWidget {
  ...
  const AnimatedCheck({super.key, required this.progress, required this.size, this.color, this.strokeWidth});
