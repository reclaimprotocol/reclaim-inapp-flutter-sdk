...
class ProviderClaimData {
  ...
  factory ProviderClaimData.fromJson(Map<String, dynamic> json) => _$ProviderClaimDataFromJson(json);
...
final class CreateClaimOutput {
  ...
  factory CreateClaimOutput.fromJson(Map<String, dynamic> json) => _$CreateClaimOutputFromJson(json);
  ...
  static List<CreateClaimOutput> fromMeChainJson(Map<String, dynamic> json) {
    ...
    return data.map((item) {
      ...
      return createClaimOutput.copyWith(taskId: taskId);
    }).toList();
  }
}
