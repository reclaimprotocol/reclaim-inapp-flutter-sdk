...
import 'package:reclaim_flutter_sdk/utils/crypto/jws.dart';
...
class CapabilityAccessToken extends ReclaimOverride<CapabilityAccessToken> {
  ...
  factory CapabilityAccessToken({required ES256Jws accessToken}) {
    ...
    final Set<Uri> authorizedParties =
        azp.split(' ').where((e) => e.isNotEmpty).map((e) => Uri.parse(e)).toSet();
  ...
  factory CapabilityAccessToken.create(
    ...
    final privateKey =
        json.decode(utf8.decode(urlSafeDecode(privateKeyString))) as Map<String, dynamic>;
