...
ProviderClaimData _$ProviderClaimDataFromJson(Map<String, dynamic> json) =>
    ProviderClaimData(
...
Map<String, dynamic> _$ProviderClaimDataToJson(ProviderClaimData instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$WitnessDataToJson(WitnessData instance) =>
    <String, dynamic>{'id': instance.id, 'url': instance.url};

CreateClaimOutput _$CreateClaimOutputFromJson(Map<String, dynamic> json) =>
    CreateClaimOutput(
      identifier: json['identifier'] as String,
      claimData: ProviderClaimData.fromJson(
        json['claimData'] as Map<String, dynamic>,
      ),
      signatures:
      ...
      witnesses:
          (json['witnesses'] as List<dynamic>)
              .map((e) => WitnessData.fromJson(e as Map<String, dynamic>))
              .toList(),
      ...
      providerRequest:
          json['providerRequest'] == null
              ...
              : DataProviderRequest.fromJson(
                json['providerRequest'] as Map<String, dynamic>,
              ),
      taskId: (json['taskId'] as num?)?.toInt(),
    );

Map<String, dynamic> _$CreateClaimOutputToJson(CreateClaimOutput instance) =>
    <String, dynamic>{
      'identifier': instance.identifier,
