...
ReclaimDataProvidersResponse _$ReclaimDataProvidersResponseFromJson(
...
Map<String, dynamic> _$ReclaimDataProvidersResponseToJson(
  ReclaimDataProvidersResponse instance,
) => <String, dynamic>{
...
ReclaimDataProviders _$ReclaimDataProvidersFromJson(
  Map<String, dynamic> json,
) => ReclaimDataProviders(
  appId: json['appId'] as String?,
  httpProvider:
      (json['httpProvider'] as List<dynamic>?)
          ?.map((e) => HttpProvider.fromJson(e as Map<String, dynamic>))
          .toList(),
);

Map<String, dynamic> _$ReclaimDataProvidersToJson(
  ReclaimDataProviders instance,
) => <String, dynamic>{
...
HttpProvider _$HttpProviderFromJson(Map<String, dynamic> json) => HttpProvider(
  ...
  additionalClientOptions:
      json['additionalClientOptions'] as Map<String, dynamic>?,
...
Map<String, dynamic> _$HttpProviderToJson(HttpProvider instance) =>
    <String, dynamic>{
...
BodySniff _$BodySniffFromJson(Map<String, dynamic> json) => BodySniff(
...
DataProviderRequest _$DataProviderRequestFromJson(Map<String, dynamic> json) =>
    DataProviderRequest(
      ...
      bodySniff:
          json['bodySniff'] == null
              ? null
              : BodySniff.fromJson(json['bodySniff'] as Map<String, dynamic>),
      requestHash: json['requestHash'] as String?,
      expectedPageUrl: json['expectedPageUrl'] as String?,
    );

Map<String, dynamic> _$DataProviderRequestToJson(
  DataProviderRequest instance,
) => <String, dynamic>{
  'url': instance.url,
...
const _$UrlTypeEnumMap = {
  UrlType.REGEX: 'REGEX',
  UrlType.CONSTANT: 'CONSTANT',
  UrlType.TEMPLATE: 'TEMPLATE',
};
...
ResponseMatch _$ResponseMatchFromJson(Map<String, dynamic> json) =>
    ResponseMatch(
...
Map<String, dynamic> _$ResponseMatchToJson(ResponseMatch instance) =>
    <String, dynamic>{
...
ResponseRedaction _$ResponseRedactionFromJson(Map<String, dynamic> json) =>
    ResponseRedaction(
...
Map<String, dynamic> _$ResponseRedactionToJson(ResponseRedaction instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$UserAgentSettingsToJson(UserAgentSettings instance) =>
