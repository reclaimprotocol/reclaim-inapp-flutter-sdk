...
Object? _base64JsonReviver(
  ...
  if (value
      is Map) {
    final hasStringKeys = value
        .keys
        .every((key) => key is String);
    final hasIntValues = value
        .values
...
String _reformatJsonStringForRPC(
    String
        jsonString) {
...
Object? _replaceBase64Json(
  ...
  if (value
    ...
    for (final entry
        in value.entries) {
      newMap[entry.key] =
          _replaceBase64Json(entry.value);
    }
    return newMap;
  }
  if (value
