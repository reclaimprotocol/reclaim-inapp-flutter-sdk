...
class InitAlgorithmWorker {
  ...
  Future<bool>
      initializeAlgorithmInBackground(
    ProverAlgorithmType
        algorithm,
    String
        keyAssetUrl,
  ...
  static final _httpCacheDirInUseByIsolates =
      <String>{};

  static Future<InitAlgorithmWorker>
      spawn([String? perIsolateHttpCacheDirName]) async {
    if (perIsolateHttpCacheDirName !=
        null) {
  ...
  static Future<bool>
    ...
    try {
      provingKeyPointer =
          _GoSliceExtension.fromUint8List(provingKey);
      r1csPointer =
          _GoSliceExtension.fromUint8List(r1cs);

      const canInitializeInIsolate =
