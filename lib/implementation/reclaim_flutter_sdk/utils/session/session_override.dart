...
class ReclaimSessionOverride
  ...
  const ReclaimSessionOverride.sessionUpdates({
    required SessionUpdateCallback
        this.updateSession,
    this.logRecord,
  }) : createSession = null;

  const ReclaimSessionOverride.session({
    required SessionCreateRequest
        this.createSession,
    required SessionUpdateCallback
        this.updateSession,
    this.logRecord,
  ...
  final SessionCreateRequest?
      createSession;

  /// {@macro session_update_callback}
  final SessionUpdateCallback?
      updateSession;

  /// {@macro session_log_record_callback}
  final SessionLogRecordCallback?
      logRecord;
  ...
  ReclaimSessionOverride
    ...
    SessionCreateRequest?
        createSession,
    SessionLogRecordCallback?
        logRecord,
    SessionUpdateCallback?
        updateSession,
  }) {
    return ReclaimSessionOverride
        ._raw(
      createSession:
