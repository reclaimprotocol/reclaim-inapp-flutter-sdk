...
class WebViewUserAgentUtil {
  ...
  static bool get _isPlatformDarwin =>
      Platform.isIOS ||
      Platform.isMacOS;
  ...
  static Future<String>
    ...
    return defaultUserAgent.replaceFirst(
        "; wv)",
        ")");
  }
  ...
  static Future<String>
    ...
    final settings =
        previousSettings?.copy() ?? InAppWebViewSettings();
    final userAgent =
        await getEffectiveUserAgent(reclaimUserAgentSettings);
    settings.userAgent =
        userAgent;
