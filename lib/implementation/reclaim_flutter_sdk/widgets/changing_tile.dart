...
class ChangingTileBuilder
  ...
  @override
  State<ChangingTileBuilder>
      createState() =>
          _ChangingTileBuilderState();
}

class _ChangingTileBuilderState
    extends State<
        ChangingTileBuilder> {
  Timer?
      _timer;
  ...
  Widget build(
    ...
    return widget.builder(
        context,
        _currentIndex.clamp(0, lastIndex));
  }
}
