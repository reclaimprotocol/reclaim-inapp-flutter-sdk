...
class SizedNetworkImage
  ...
  @override
  State<SizedNetworkImage>
      createState() =>
          _SizedNetworkImageState();
}

class _SizedNetworkImageState
    extends State<
        SizedNetworkImage> {
  ...
  void
    ...
    super
        .initState();
    _imageData =
        _fetchImageData(widget.imageUrl);
  }

  Future<Uint8List>
      _fetchImageData(String url) async {
    try {
      final dio =
          Dio();
      ...
      return Uint8List.fromList(List.filled(1,
          255));
    }
  }
