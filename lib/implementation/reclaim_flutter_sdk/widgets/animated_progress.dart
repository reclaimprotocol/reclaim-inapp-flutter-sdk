...
class AnimatedLinearProgressIndicator
  ...
  @override
  State<AnimatedLinearProgressIndicator>
      createState() =>
...
class _AnimatedLinearProgressIndicatorState
  ...
  void didUpdateWidget(
      covariant AnimatedLinearProgressIndicator
          oldWidget) {
  ...
  Widget build(
    ...
    final backgroundColor =
        widget.backgroundColor ?? const Color(0xFFF2F2F7);
    final valueColor =
        AlwaysStoppedAnimation<Color>(widget.valueColor);
    final minHeight =
        widget.minHeight ?? 6.0;
    final borderRadius =
        widget.borderRadius;
...
class AnimatedCardProgressIndicator
    extends StatefulWidget {
  ...
  @override
  State<AnimatedCardProgressIndicator>
      createState() =>
...
class _AnimatedCardProgressIndicatorState
  ...
  @override
  void didUpdateWidget(
      covariant AnimatedCardProgressIndicator
          oldWidget) {
    super.didUpdateWidget(
        oldWidget);
    if (widget.progress !=
