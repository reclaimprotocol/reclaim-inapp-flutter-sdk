...
class HashedValueSpoilerTextSpan
    extends WidgetSpan {
  final String
      value;
  final String?
...
class HashedValueTextSpanWidget
  ...
  @override
  State<HashedValueTextSpanWidget>
      createState() =>
          _HashedValueTextSpanWidgetState();
}

enum _HashedValueRevealType {
  unrevealed,
  displayUnsharedValue,
  displayHash
}

class _HashedValueTextSpanWidgetState
    extends State<
        HashedValueTextSpanWidget> {
  _HashedValueRevealType
      _revealType =
      _HashedValueRevealType.unrevealed;
  ...
  bool
    ...
    return previous !=
        _HashedValueRevealType.displayUnsharedValue;
  }
