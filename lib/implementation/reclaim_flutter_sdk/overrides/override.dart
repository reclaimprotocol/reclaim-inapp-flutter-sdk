abstract class ReclaimOverride<
    T extends ReclaimOverride<
        T>> {
  ...
  static T?
      get<T extends ReclaimOverride<T>>() {
    return _overrides[T]
        as T?;
  }

  static void
      set(ReclaimOverride<dynamic> override) {
    _overrides =
        _overridesIterableToMap({
      ..._overrides.values,
      override,
    });
  }
  ...
  static void
      setAll(Iterable<ReclaimOverride<dynamic>> overrides) {
    _overrides =
        _overridesIterableToMap({
      ..._overrides.values,
      ...overrides,
  ...
  static Map<
      Object,
      ReclaimOverride<dynamic>> _overridesIterableToMap(
    Iterable<ReclaimOverride<dynamic>>
        overridesIterable,
  ) {
    return Map<
        Object,
        ReclaimOverride<dynamic>>.unmodifiable(
      <Object,
          ReclaimOverride<dynamic>>{
