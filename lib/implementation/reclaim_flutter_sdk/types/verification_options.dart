...
import '../data/providers.dart'
    show
        HttpProvider;
import '../src/attestor/data/attestor/auth.dart'
    show
        AttestorAuthenticationRequest;

typedef ReclaimAttestorAuthenticationRequestCallback
    = FutureOr<AttestorAuthenticationRequest>
        Function(
  HttpProvider
      provider,
);
