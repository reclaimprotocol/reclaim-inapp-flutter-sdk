...
class ProviderClaimData {
  ...
  Map<String,
          dynamic>
      toJson() =>
          _$ProviderClaimDataToJson(this);
}
...
class CreateClaimOutput {
  final String
      identifier;
  final ProviderClaimData
      claimData;
  final List<String>
      signatures;
  final List<WitnessData>
      witnesses;
  final int?
      taskId;
  Object?
  ...
  Map<String,
          dynamic>
      toJson() =>
          _$CreateClaimOutputToJson(this);

  static List<CreateClaimOutput>
      fromMeChainJson(Map<String, dynamic> json) {
    final taskId =
        json['taskId'] as int;
    final data =
    ...
    return data
        .map((item) {
      final createClaimOutput =
          CreateClaimOutput.fromJson(item);
