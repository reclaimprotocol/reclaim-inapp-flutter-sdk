...
RequestLog
    _$RequestLogFromJson(Map<String, dynamic> json) =>
        RequestLog(
...
ManualVerificationParameter
    _$ManualVerificationParameterFromJson(
  Map<String,
          dynamic>
      json,
) =>
...
Map<String,
    dynamic> _$ManualVerificationParameterToJson(
  ManualVerificationParameter
      instance,
) =>
    <String, dynamic>{
...
Map<String,
    dynamic> _$CreateManualVerificationSessionPayloadToJson(
  CreateManualVerificationSessionPayload
      instance,
) =>
    <String, dynamic>{
