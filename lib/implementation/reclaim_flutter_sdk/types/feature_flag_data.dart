...
class ReclaimFeatureFlagData
  ...
  ReclaimFeatureFlagData
    ...
    return ReclaimFeatureFlagData(
      cookiePersist:
          cookiePersist ?? this.cookiePersist,
      singleReclaimRequest:
          singleReclaimRequest ?? this.singleReclaimRequest,
      idleTimeThresholdForManualVerificationTrigger:
      ...
      isAIFlowEnabled:
          isAIFlowEnabled ?? this.isAIFlowEnabled,
      canUseAiFlow:
          canUseAiFlow ?? this.canUseAiFlow,
    );
  }
