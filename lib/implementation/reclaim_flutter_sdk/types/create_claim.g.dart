...
ProviderClaimData
    _$ProviderClaimDataFromJson(Map<String, dynamic> json) =>
        ProviderClaimData(
...
Map<String,
    dynamic> _$ProviderClaimDataToJson(
        ProviderClaimData
            instance) =>
    <String,
        dynamic>{
...
CreateClaimOutput
    _$CreateClaimOutputFromJson(Map<String, dynamic> json) =>
        CreateClaimOutput(
          identifier: json['identifier'] as String,
...
Map<String,
    dynamic> _$CreateClaimOutputToJson(
        CreateClaimOutput
            instance) =>
    <String,
        dynamic>{
