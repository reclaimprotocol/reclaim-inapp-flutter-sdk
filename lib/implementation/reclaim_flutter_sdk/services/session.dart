...
class ReclaimSessionInformation {
  ...
  bool
      get isValid {
    return signature.trim().isNotEmpty &&
        timestamp.trim().isNotEmpty;
  }

  static Future<ReclaimSessionInformation>
      generateNew({
    required String
        providerId,
    required String
    ...
    final signature = signMap(
        options,
        applicationSecret);

    try {
      final sessionId =
          await ReclaimSession.createSession(
        appId: applicationId,
