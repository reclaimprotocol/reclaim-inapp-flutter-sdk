...
typedef AttestorResponseTransformer<
        RESPONSE>
    = FutureOr<RESPONSE>
        Function(dynamic value);
typedef AttestorCreateClaimPerformanceReportCallback
    = void
        Function(Iterable<ZKComputePerformanceReport> performanceReports);
...
abstract class AttestorClient {
  ...
  final List<ZKComputePerformanceReport>
      _performanceReports =
      [];
  ...
  AttestorProcess<
      AttestorClaimRequest,
      List<AttestorClaimResponse>> createClaim({
    ...
    final result =
        sendRequest(
      type:
          options.claimCreationType.type,
      request:
          AttestorClaimRequest.create(
        request: request,
        options: options,
      ...
      transformResponse:
        ...
        if (onPerformanceReports != null) {
          onPerformanceReports(List.unmodifiable([
            ..._performanceReports
          ]));
        }
        _clearPerformanceReports();
        ...
        return [
          AttestorClaimResponse.fromJson(value)
        ];
      },
    );
  ...
  AttestorProcess<REQUEST, RESPONSE> sendRequest<
    ...
    required REQUEST
        request,
    required AttestorResponseTransformer<RESPONSE>
        transformResponse,
  });
