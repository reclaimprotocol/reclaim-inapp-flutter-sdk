...
class ReclaimProviderOverride
  ...
  final ProviderInformationCallback?
      fetchProviderInformation;

  const ReclaimProviderOverride({
    required this.fetchProviderInformation,
  });

  @override
  ReclaimProviderOverride
      copyWith({
    ProviderInformationCallback?
        fetchProviderInformation,
  }) {
    return ReclaimProviderOverride(
      fetchProviderInformation:
          fetchProviderInformation ?? this.fetchProviderInformation,
    );
  }
}
